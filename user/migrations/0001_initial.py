...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role_type', models.CharField(choices=[('U', 'User'), ('FPM', 'Feeds Post Manager'), ('NPM', 'News Post Manager'), ('PM', 'Post Manager'), ('C', 'Consultant'), ('A', 'Admin'), ('SA', 'Super Admin')], max_length=50)),
